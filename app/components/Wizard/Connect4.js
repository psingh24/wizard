...
var Connect4 = createReactClass({
  render: function() {
    return (
     <div>
         <Image src="assets/image/smartphones.svg" class="imageSmartPhone"/>
         ...
         <div className="noEthernetBTN"><Button className="btnLarge" bsStyle="primary">SKIP THIS STEP</Button></div>
     </div>
